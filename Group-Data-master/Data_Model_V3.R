...
model_coefficients <- as_tibble(tibble::rownames_to_column(as.data.frame(summary(step_lm)$coefficients)))

write_csv(model_coefficients, "model_coefficients_V3.csv")
