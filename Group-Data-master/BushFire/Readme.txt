========================================================
README: LINKING HOTSPOT PIXELS WITH PROPERTY GEOCODE
========================================================
Purpose:
This document explains about the R script and the results prepared for extracting Bushfire information via NASA FIRMS organisation.

Data Collected:
Nasa_fIRMS   : https://firms.modaps.eosdis.nasa.gov/download/ (rawdata :173MB) 
ATO Deferral : https://www.ato.gov.au/Individuals/Dealing-with-disasters/In-detail/Specific-disasters/Bushfires-2019-20/?anchor=NotinanimpactedpostcodeorLGA

Comparison Data:
Data is against the collected Property Data.
...
Filter condition:
NASA_Firms   : Applied 'h' confidence interval, Geocode within properties identified in NSW & restricted all postcodes of ATO Deferred and some non-deferred
ATO_Deferral : filter applied to NSW
GEEBAM       : Only NSW

Process:
Using Geosphere package and the function distharvesine is used to identify the areas having 'h' confidence recorded by NASA Firms.
It uses the logic of extracting >15km radius Geocode locations for every property belonged to ATO deferred region.

Output Format:
Lat/Long/Confidence/Acq_Date/Distance/P.No/Postcode/ATO_Flag
 
Scripts and Output Files:
Prep_Bushfire_2018-19.R : Bushfire/Results/NASA_Firms_Impact_15km_2018.csv
Prep_BushFire_2019-20.R : Bushfire/Results/NASA_Firms_Impact_15km_2019.csv
Prep_PostCode_ATO.R : Bushfire/Results/ATO_Deferred.csv
Link_ATO_Bushfire.R : Bushfire/Results/NASA_Firms_Impact_15km_2018_atoflag.csv
                      Bushfire/Results/NASA_Firms_Impact_15km_2019_atoflag.csv
 
Other Referenced Data: They are used to gather references around bushfire impacted area and not used directly.
GEEBAM
GNAF-20
